...
const steps = [
  { id: "01", name: "Ügyfél kiválasztása", href: "#", status: "complete" },
  { id: "02", name: "Ajánlat adatok megadása", href: "#", status: "current" },
  { id: "03", name: "Termékek hozzáadása", href: "#", status: "upcoming" },
  { id: "04", name: "Kész ajánlat", href: "#", status: "upcoming" },
];

const Steps = () => {
  return (
    <nav aria-label="Progress" className="-mt-14 mb-4 bg-white">
      <ol
        role="list"
